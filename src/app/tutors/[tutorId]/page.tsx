        ...
        <section className="relative h-64 md:h-96 bg-elite-primary-900 overflow-hidden">
           ...
           <div className="container mx-auto px-4 h-full relative">
              <div className="absolute -bottom-16 left-4 md:left-8 flex flex-col md:flex-row items-end gap-6">
                 <div className="w-32 h-32 md:w-48 md:h-48 rounded-3xl bg-elite-primary-100 border-[6px] border-white dark:border-elite-primary-950 flex items-center justify-center font-bold text-5xl text-elite-primary-900 shadow-2xl">DM<MobileBottomNav />
      </div>
                 ...
                 <Card className="border-none shadow-2xl overflow-hidden sticky top-32">
                    <CardContent className="p-8 space-y-6">
                       <div className="grid grid-cols-3 gap-4 text-center">
                          <div>
                             <div className="text-2xl font-bold font-space-grotesk">4.9<MobileBottomNav />
      </div>
                             <div className="text-[10px] uppercase font-bold text-elite-primary-400 tracking-tighter">Rating<MobileBottomNav />
      </div>
                          <MobileBottomNav />
      </div>
                          <div className="border-x border-elite-primary-50 px-4">
                             <div className="text-2xl font-bold font-space-grotesk">12k<MobileBottomNav />
      </div>
                             <div className="text-[10px] uppercase font-bold text-elite-primary-400 tracking-tighter">Students<MobileBottomNav />
      </div>
                          <MobileBottomNav />
      </div>
                          <div>
                             <div className="text-2xl font-bold font-space-grotesk">15<MobileBottomNav />
      </div>
                             <div className="text-[10px] uppercase font-bold text-elite-primary-400 tracking-tighter">Courses<MobileBottomNav />
      </div>
                          <MobileBottomNav />
      </div>
                       <MobileBottomNav />
